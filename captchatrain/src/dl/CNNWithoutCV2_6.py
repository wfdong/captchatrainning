...
def evaluate_lenet5(learning_rate=0.05, n_epochs=100,
                    nkerns=[72, 192, 288, 288], batch_size=500):
    ...
    layer2 = HiddenLayer(rng, input=layer2_input, n_in=nkerns[3] * 3 * 3,
                         n_out=2880, activation=T.tanh)

    # classify the values of the fully-connected sigmoidal layer
    layer3 = LogisticRegression(input=layer2.output, n_in=2880, n_out=58)
