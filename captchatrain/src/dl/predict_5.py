...
def build_lenet5(params, nkerns=[48, 128, 192, 192], batch_size=1):
    ...
    layer0 = LeNetConvPoolLayer(params[5], input=layer0_input,
    ...
    layer1 = LeNetConvPoolLayer(params[4], input=layer0.output,
    ...
    layer1_3 = LeNetConvPoolLayerNoPooling(params[3], input=layer1.output,
            image_shape=(batch_size, nkerns[1], 10, 10),
            filter_shape=(nkerns[2], nkerns[1], 3, 3))
    
    layer1_4 = LeNetConvPoolLayer(params[2], input=layer1_3.output,
    ...
    layer3 = LogisticRegression(params[0], input=layer2.output, n_in=1920, n_out=58)
...
def readParams():
    save_file = open('../data/params-5-2', 'rb')
    params = []
    for i in range(6):
...
def getProb(predict_model, imgPath):
    img = cv2.imread(imgPath, 0)
    i1 = (0, 50)
    i2 = (25, 75)
    i3 = (55, 105)
