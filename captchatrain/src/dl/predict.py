...
'''
def build_lenet5(params, nkerns=[20, 50], batch_size=1):
    ...
    layer0 = LeNetConvPoolLayer(params[3], input=layer0_input,
    ...
    layer1 = LeNetConvPoolLayer(params[2], input=layer0.output,
    ...
    layer2 = HiddenLayer(None, input=layer2_input, n_in=nkerns[1] * 4 * 4,
                         n_out=500, W=params[1][0], b=params[1][1], activation=T.tanh)

    # classify the values of the fully-connected sigmoidal layer
    layer3 = LogisticRegression(params[0], input=layer2.output, n_in=500, n_out=58)
