...
def evaluate_lenet5(params, learning_rate=0.1, n_epochs=120,
    ...
    layer0 = Model.LeNetConvPoolLayer(params[4], input=layer0_input,
    ...
    layer1 = Model.LeNetConvPoolLayer(params[3], input=layer0.output,
            image_shape=(batch_size, nkerns[0], 23, 23),
            filter_shape=(nkerns[1], nkerns[0], 3, 3), poolsize=(2, 2))
    
    layer1_3 = Model.LeNetConvPoolLayer(params[2], input=layer1.output,
    ...
    layer2 = HiddenLayer(None, input=layer2_input, n_in=nkerns[2] * 4 * 4,
                         n_out=960, W=params[1][0], b=params[1][1], activation=T.tanh)

    # classify the values of the fully-connected sigmoidal layer
    layer3 = Model.LogisticRegression(params[0], input=layer2.output, n_in=960, n_out=58)
...
if __name__ == '__main__':
    ...
    params = DLUtil.readParams('../data/params-2', 5)
